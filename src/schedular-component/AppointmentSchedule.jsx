...
const AppointmentSchedule = (props) => {
    ...
    const ReviewAppointment = () => {
        console.log(scheduler, 'sc')
        console.log(document.getElementById("provide-group").value, 'ev.text')
        var ev = scheduler.getEvent(scheduler.getState().lightbox_id);
        ev.text = document.getElementById("provide-group").value;
        ...
        <>
            <div className="patient-details-wrapper">
                ...
                <div className="btn-wrapper">
                    ...
                    <button id="save" className="secondary" onClick={ReviewAppointment}>Review</button>
                </div>
            </div>
        </>
    )
